<template>
  <div class="meta-track" :class="[`meta-track--${type}`, { 'is-vinyl': isVinylMode }]">
    <div class="sleeve-wrapper">
      <a v-if="track.url" :href="track.url" target="_blank" class="sleeve-link" @click.stop>
        <img :src="imageSrc" class="meta-track__image" :alt="label" />
